...
"     endif
"
"     syn keyword antlrKeyword import fragment lexer parser grammar returns
"     locals throws catch finally mode options tokens header members init
"     after channels mode protected public private
"
"     syn keyword antlrReserved rule
"
"     syn match  antlrCharacter '\\\(r\|n\|t\|f\|b\|"\|\'\|\\\|u\x\{4}\)'
"     contained display
"
...
"     syn region antlrAction matchgroup=antlrBlock start="{" end="}"
"     contains=antlrVariable,antlrAction
"     syn match antlrVariable contained "$[a-zA-Z][a-zA-Z_0-9]*"
"
"     syn include @JAVA syntax/java.vim
"     syn region ANTLR4EmbeddedJavaAction matchgroup=antlrBlock start="{"
"     end="}" contains=@JAVA,antlrVariable containedin=antlrAction
"
"     syn keyword antlrOperations pushMode popMode skip channel
"
"     syn match antlrBrace "[\[\]]"
"     syn region antlrCharClass matchgroup=antlrBrace start="\[" end="\]"
"     contains=antlrCharacter
"
